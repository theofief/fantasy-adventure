...
final class LandingController extends AbstractController
{
    ...
    #[Route(
        ...
        name: 'landing_asset',
        methods: ['GET'],
        requirements: ['path' => '(?!api/|_profiler/|_wdt/).+\.(?:png|jpe?g|gif|webp|svg|ico|css|js|map|json|woff2?|ttf|otf)$'],
        priority: -100,
    )]
    public function asset(string $path): Response
    {
        ...
        if ($fullPath === false || !str_starts_with($fullPath, $projectRoot) || !is_file($fullPath)) {
