...
CERT_FILE="${CERT_FILE:-/etc/letsencrypt/live/fantasyadventure.ddns.net/fullchain.pem}"
KEY_FILE="${KEY_FILE:-/etc/letsencrypt/live/fantasyadventure.ddns.net/privkey.pem}"
LOG_DIR="var/log"
