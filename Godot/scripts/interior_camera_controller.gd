...
const BASE_INTERIOR_ZOOM := 3.8
const MIN_INTERIOR_ZOOM := 3.15
const MAX_INTERIOR_ZOOM := 5.2
...
func _apply_camera_zoom() -> void:
	...
	var target_zoom := clampf(BASE_INTERIOR_ZOOM * viewport_scale, MIN_INTERIOR_ZOOM, MAX_INTERIOR_ZOOM)
...
func _find_player_camera() -> Camera2D:
	...
	if body == null:
		return null
	return body.get_node_or_null("Camera2D") as Camera2D
