...
/** @type {string} */
const CACHE_VERSION = '1770643533|113390622';
/** @type {string} */
const CACHE_PREFIX = 'Fantasy Adventur-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Fantasy Adventure.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Fantasy Adventure.html","Fantasy Adventure.js","Fantasy Adventure.offline.html","Fantasy Adventure.icon.png","Fantasy Adventure.apple-touch-icon.png","Fantasy Adventure.audio.worklet.js","Fantasy Adventure.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Fantasy Adventure.wasm","Fantasy Adventure.pck"];
